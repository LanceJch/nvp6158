...
NC_VD_COAX_Init_STR coax_init_lists[]=
{
	...
	[ AHD20_1080P_30P ] = {
		...
		.tx_pel_line_pos0  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_pel_line_pos1  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_count_max = 0x03,//0x08   reg0x0a
		.tx_mode 		   = 0x10,
	...
	[ AHD30_4M_15P ] = {
		...
		.tx_line_count_max = 0x07,
		.tx_mode 		   = 0x10,
		//.tx_sync_pos0 	   = { 0xa0, 0x00, 0x00, 0x00, 0x00, 0x00 },		//解决富翰方案 左右键变成 上下键
		//.tx_sync_pos1 	   = { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00 },
	...
	[ AHD30_5M_12_5P ] = {
		...
		.tx_line_count_max = 0x07,
		.tx_mode 		   = 0x10,
		//.tx_sync_pos0 	   = { 0x30, 0x00, 0x00, 0x00, 0x00, 0x00 },		//解决富翰方案 左右键变成 上下键
	...
	[ AHD30_5M_20P ] = {
		...
		.tx_line_pos0 	   = { 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_pos1 	   = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_count 	   = 0x07,//05
		.tx_pel_line_pos0  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_pel_line_pos1  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_line_count_max = 0x07,  //0a
		.tx_mode 		   = 0x10,
		.tx_sync_pos0 	   = { 0xa0, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_sync_pos1 	   = { 0x01, 0x00, 0x00, 0x00, 0x00, 0x00 },
		.tx_even 		   = 0x00,
...
NC_VD_ACP_CMDDEF_STR coax_cmd_lists[]=
{
	...
	[ COAX_CMD_FOCUS_INC ] = {
			...
			.ahd_8bit     	= { 0x00, 0x80, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, EOD },
	...
	[ COAX_CMD_FOCUS_DEC ] = {
			...
			.ahd_8bit     	= { 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, EOD },
	...
	[ COAX_CMD_ZOOM_INC ] = {
			...
			.ahd_8bit 	= { 0x00, 0x20, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, EOD },
	...
	[ COAX_CMD_ZOOM_DEC ] = {
			...
			.ahd_8bit 	= { 0x00, 0x40, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00, EOD },
...
*/
	...
	[ COAX_CMD_STOP ] = {
			...
			.sd  		  = { 0x00, 0x00, 0x00, 0x00, EOD },
			.autostop  = 1,
	},

	/*****************	补全各类型摄像头,防止摄像头不支持的UI控件触发(eg.CVI 2M 不支持"左上"),无数据操作死内核---直接传stop命令	*************/
	[ COAX_CMD_LEFT_UP ] = {
			.name		= "COAX_CMD_LEFT_UP",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x0A, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_LEFT_DOWN ] = {
			.name		= "COAX_CMD_LEFT_DOWN",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x14, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x0B, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_RIGHT_UP ] = {
			.name		= "COAX_CMD_RIGHT_UP",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x0C, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_RIGHT_DOWN ] = {
			.name		= "COAX_CMD_RIGHT_DOWN",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x0D, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	...
	[ COAX_CMD_SET_POINT ] = {
			.name		= "COAX_CMD_SET_POINT",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },
			.cvi_new_cmd  = { 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, EOD },	
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x15, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_CLEAR_POINT ] = {
			.name		= "COAX_CMD_CLEAR_POINT",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },
			.cvi_new_cmd  = { 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, EOD },
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x16, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_GOTO_POINT ] = {
			.name		= "COAX_CMD_GOTO_POINT",
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },
			.cvi_new_cmd  = { 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, EOD },	
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x17, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },		////未定义
			.sd  		  = { 0x40, 0x00, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_AUTO ] = {
			...
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x07, 0x00, 0x63, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x17, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
	...
	[ COAX_CMD_AUTO_STOP ] = {
			...
			.ahd_16bit    = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x07, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0	= { 0xb5, 0x00, 0x17, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
	...
	[ COAX_CMD_SCAN_SR ] = {
			.name		= "COAX_CMD_SCAN_SR",
			.ahd_16bit	= { 0x00, 0xE0, 0xE0, 0x46, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd			= { 0x00, 0xE0, 0x00, 0x46, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_SCAN_ST ] = {
			.name		= "COAX_CMD_SCAN_ST",
			.ahd_16bit	= { 0x00, 0xE0, 0xE0, 0x00, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			.cvi_checksum = { 0xec, 0xff, 0xff, 0xff, 0xff, 0xff, EOD },								////未定义
			.sd 		= { 0x00, 0xE0, 0x00, 0x00, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PRESET1 ] = {
			.name		= "COAX_CMD_PRESET1",
			.ahd_16bit	= { 0x00, 0xE0, 0xE0, 0x80, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd			= { 0x00, 0xE0, 0x00, 0x80, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PRESET2 ] = {
			.name		= "COAX_CMD_PRESET2",
			.ahd_16bit	= { 0x00, 0xE0, 0xE0, 0x40, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd			= { 0x00, 0xE0, 0x00, 0x40, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PRESET3 ] = {
			.name		= "COAX_CMD_PRESET3",
			.ahd_16bit	= { 0x00, 0xE0, 0xE0, 0xC0, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd			= { 0x00, 0xE0, 0x00, 0xC0, EOD },
			.autostop	= 1,
	},	
	[ COAX_CMD_PTN1_SR ] = {
			.name		= "COAX_CMD_PTN1_SR",
			.ahd_16bit	= { 0x00, 0xF8, 0xF8, 0x01, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0xF8, 0x00, 0x01, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PTN1_ST ] = {
			.name		= "COAX_CMD_PTN1_ST",
			.ahd_16bit	= { 0x00, 0x84, 0x84, 0x01, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0x84, 0x00, 0x01, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PTN2_SR ] = {
			.name		= "COAX_CMD_PTN2_SR",
			.ahd_16bit	= { 0x00, 0xF8, 0xF8, 0x02, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0xF8, 0x00, 0x02, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PTN2_ST ] = {
			.name		= "COAX_CMD_PTN2_ST",
			.ahd_16bit	= { 0x00, 0x84, 0x84, 0x02, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0x84, 0x00, 0x02, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PTN3_SR ] = {
			.name		= "COAX_CMD_PTN3_SR",
			.ahd_16bit	= { 0x00, 0xF8, 0xF8, 0x03, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0xF8, 0x00, 0x03, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_PTN3_ST ] = {
			.name		= "COAX_CMD_PTN3_ST",
			.ahd_16bit	= { 0x00, 0x84, 0x84, 0x03, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0x84, 0x00, 0x03, EOD },
			.autostop	= 1,
	},
	[ COAX_CMD_RUN ] = {
			.name		= "COAX_CMD_RUN",
			.ahd_16bit	= { 0x00, 0xC4, 0xC4, 0x00, EOD },
			.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.cvi_cmd      = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
			.cvi_new_cmd  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, EOD },		////未定义
			...
			.tvi_v1_0 	  = { 0xb5, 0x00, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc9, 0x80, EOD },
			.tvi_v2_0     = { 0xb5, 0x01, 0x14, 0x00, 0x80, 0x00, 0x00, 0x00, 0xc5, 0x80, EOD },
			.sd 		= { 0x00, 0xC4, 0x00, 0x00, EOD },
			.autostop	= 1,
	},	

	
	[ COAX_CMD_SET_WHITE_LED ] = {
			.name		= "COAX_CMD_SET_WHITE_LED",
			.ahd_16bit	  = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x07, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd	  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
	...
	[ COAX_CMD_SET_WHITE_LED_MODE ] = {
			.name		= "COAX_CMD_SET_WHITE_LED_MODE",
			.ahd_16bit	  = { 0x00, 0x00, 0x00, 0x00, EOD },			////未定义
			.ahd_8bit	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
			.ahd_4_5m	= { 0x00, 0x07, 0x00, 0x60, 0x00, 0x00, 0x00, 0x00, EOD },
			.cvi_cmd	  = { 0xa5, 0x80, 0x02, 0x00, 0x00, 0x00, 0x67, 0xff, 0xff, 0xff, 0xff, 0xff,  0xff, 0xff, 0xff, 0xff, EOD },			////未定义
	...
	[ COAX_CMD_UNKNOWN ] = {
		.name		= "COAX_CMD_UNKNOWN",
		.ahd_16bit	= { 0x00, 0x00, 0x00, 0x00, EOD },
		.ahd_8bit 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
		.ahd_4_5m 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },					////未定义
		.cvi_cmd      = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00, EOD },			////未定义
		.cvi_new_cmd  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },		////未定义
		.cvi_checksum = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },								////未定义
		.tvi_v1_0 	  = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
		.tvi_v2_0     = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, EOD },
		.sd 		= { 0x00, 0x00, 0x00, 0x00, EOD },
		.autostop	= 1,
	},			
	/*******************************************/
