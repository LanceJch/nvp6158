...
video_equalizer_distance_table_s equalizer_distance_fmtdef[ NC_VIVO_CH_FORMATDEF_MAX ] =
{
		...
		[ CVI_4M_25P ] = { /* o */
				...
				#else
				{
					.hsync_stage[0] = 0x8a0000,	/* short */
					.hsync_stage[1] = 0x890000,	/* 100m  */
					.hsync_stage[2] = 0x84493a,	/* 200m  */
					.hsync_stage[3] = 0x81efff,	/* 300m  */
					.hsync_stage[4] = 0x7f0000,	/* 400m  */
					.hsync_stage[5] = 0x3c5cf7,	/* 500m  */
				},
				#endif
				{
		...
		[ CVI_8M_15P ] = { /* x */
				...
				{
					.hsync_stage[0] = 0x330dfb,	/* short */
					.hsync_stage[1] = 0x300000,	/* 100m  */
					.hsync_stage[2] = 0x2bc294,	/* 200m  */
					.hsync_stage[3] = 0x29d880,	/* 300m  */
					.hsync_stage[4] = 0x260014,	/* 400m  */
					.hsync_stage[5] = 0x127ff6,	/* 500m  */
				},
				#endif
				{
		...
		[ CVI_FHD_30P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x8ba000,	/* short */
					.hsync_stage[1] = 0x875000,	/* 100m  */
					.hsync_stage[2] = 0x84516d,	/* 200m  */
					.hsync_stage[3] = 0x7fd755,	/* 300m  */
					.hsync_stage[4] = 0x7d8000,	/* 400m  */
					.hsync_stage[5] = 0x3ba64a,	/* 500m  */
				},
				#endif
				{
		...
		[ CVI_FHD_25P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x8b0000,	/* short */
					.hsync_stage[1] = 0x885000,	/* 100m  */
					.hsync_stage[2] = 0x84516d,	/* 200m  */
					.hsync_stage[3] = 0x7fd755,	/* 300m  */
					.hsync_stage[4] = 0x7c0000,	/* 400m  */
					.hsync_stage[5] = 0x3ba64a,	/* 500m  */
				},
				#endif
				{
		...
		[ AHD30_4M_25P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x320000,	/* short */
					.hsync_stage[1] = 0x30a000,	/* 100m  */
					.hsync_stage[2] = 0x2c4744,	/* 200m  */
					.hsync_stage[3] = 0x29a0c2,	/* 300m  */
					.hsync_stage[4] = 0x26b000,	/* 400m  */
					.hsync_stage[5] = 0x125205,	/* 500m  */
				},
				#endif
				{
		...
		[ AHD30_4M_30P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x322000,	/* short */
					.hsync_stage[1] = 0x2ff000,	/* 100m  */
					.hsync_stage[2] = 0x2c0e66,	/* 200m  */
					.hsync_stage[3] = 0x28a597,	/* 300m  */
					.hsync_stage[4] = 0x25f000,	/* 400m  */
					.hsync_stage[5] = 0x123296,	/* 500m  */
				},
				#endif
				{
		...
		[ AHD30_4M_15P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x318000,	/* short */
					.hsync_stage[1] = 0x308000,	/* 100m  */
					.hsync_stage[2] = 0x2d0000,	/* 200m  */
					.hsync_stage[3] = 0x2c134f,	/* 300m  */
					.hsync_stage[4] = 0x2a5000,	/* 400m  */
					.hsync_stage[5] = 0x141b60,	/* 500m  */
				},
				#endif
				{
		...
		[ AHD30_8M_15P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x325000,	/* short */
					.hsync_stage[1] = 0x303000,	/* 100m  */
					.hsync_stage[2] = 0x2d0e66,	/* 200m  */
					.hsync_stage[3] = 0x2ba597,	/* 300m  */
					.hsync_stage[4] = 0x29c000,	/* 400m  */
					.hsync_stage[5] = 0x123296,	/* 500m  */
				},
				#endif
				{
		...
		[ TVI_4M_25P ] = { /* x */
				...
				{
					.hsync_stage[0] = 0x325000,	/* short */
					.hsync_stage[1] = 0x304000,	/* 100m  */
					.hsync_stage[2] = 0x2bc444,	/* 200m  */
					.hsync_stage[3] = 0x2a931F,	/* 300m  */
					.hsync_stage[4] = 0x285000,	/* 400m  */
					.hsync_stage[5] = 0x12F1C5,	/* 500m  */
				},
				#endif
				{
		...
		[ TVI_4M_30P ] = { /* x */
				...
				#else
				{
					...
					.hsync_stage[1] = 0x304000,	/* 100m  */
					.hsync_stage[2] = 0x2B933F,	/* 200m  */
					.hsync_stage[3] = 0x29E08D,	/* 300m  */
					.hsync_stage[4] = 0x28D000,	/* 400m  */
					.hsync_stage[5] = 0x12EF4B,	/* 500m  */
				},
				#endif
				{
		...
		[ AHD30_5M_20P ] = { /* x */
				...
				#else
				{
					.hsync_stage[0] = 0x8ad000,	/* short */
					.hsync_stage[1] = 0x894000,	/* 100m  */
					.hsync_stage[2] = 0x878cbc,	/* 200m  */
					.hsync_stage[3] = 0x83dea5,	/* 300m  */
					.hsync_stage[4] = 0x7fa000,	/* 400m  */
					.hsync_stage[5] = 0x3ef336,	/* 500m  */
				},
				#endif
				{
		...
		[ TVI_5M_12_5P ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x326000,	/* short */
				.hsync_stage[1] = 0x305000,	/* 100m  */
				.hsync_stage[2] = 0x2bba9d,	/* 200m  */
				.hsync_stage[3] = 0x2a0792,	/* 300m  */
				.hsync_stage[4] = 0x290000,	/* 400m  */
				.hsync_stage[5] = 0x12bbd8,	/* 500m  */
			},
			#endif
			{
		...
		[ TVI_5M_20P ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x68C000,	/* short */
				.hsync_stage[1] = 0x66E000,	/* 100m  */
				.hsync_stage[2] = 0x657398,	/* 200m  */
				.hsync_stage[3] = 0x622369,	/* 300m  */
				.hsync_stage[4] = 0x5A8000,	/* 400m  */
				.hsync_stage[5] = 0x2DC8C7,	/* 500m  */
			},
			#endif
			{
		...
		[ TVI_8M_15P ] = { /* x */
			...
			#else
			{
				.hsync_stage[0] = 0x340dfb, /* short */
				.hsync_stage[1] = 0x31b000, /* 100m  */
				.hsync_stage[2] = 0x2bc294, /* 200m  */
				.hsync_stage[3] = 0x2ad880, /* 300m  */
				.hsync_stage[4] = 0x28a014, /* 400m  */
				.hsync_stage[5] = 0x127ff6, /* 500m  */
			},
			#endif
			{
		...
		[ TVI_3M_18P ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x31a000,	/* short */
				.hsync_stage[1] = 0x2fc000,	/* 100m  */
				.hsync_stage[2] = 0x2d6833,	/* 200m  */
				.hsync_stage[3] = 0x2a8695,	/* 300m  */
				.hsync_stage[4] = 0x280000,	/* 400m  */
				.hsync_stage[5] = 0x13101d,	/* 500m  */
			},
			#endif
			{
		...
		[ AHD20_1080P_25P ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x8B5000,	/* short */
				.hsync_stage[1] = 0x8A0000,	/* 100m  */
				.hsync_stage[2] = 0x890000,	/* 200m  */
				.hsync_stage[3] = 0x870000,	/* 300m  */
				.hsync_stage[4] = 0x846EAE,	/* 400m  */
				.hsync_stage[5] = 0x41789C,	/* 500m  */
			},
			#endif
		...
		[ AHD20_1080P_30P ] = { /* o */
			...
			{
				.hsync_stage[0] = 0x8B0000,	/* short */
				.hsync_stage[1] = 0x88A000,	/* 100m  */
				.hsync_stage[2] = 0x860000,	/* 200m  */
				.hsync_stage[3] = 0x840000,	/* 300m  */
				.hsync_stage[4] = 0x810000,	/* 400m  */
				.hsync_stage[5] = 0x4029ee,	/* 500m  */
			},
			#endif
			{
		...
		[ TVI_FHD_30P ] = { /* o */
			...
			{
				.hsync_stage[0] = 0x31a000,	/* short */
				.hsync_stage[1] = 0x2e0000,	/* 100m  */
				.hsync_stage[2] = 0x2ad6af,	/* 200m  */
				.hsync_stage[3] = 0x290000,	/* 300m  */
				.hsync_stage[4] = 0x27D000,	/* 400m  */
				.hsync_stage[5] = 0x117635,	/* 500m  */
			},
			#endif
			{
		...
		[ TVI_FHD_25P ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x315000,	/* short */
				.hsync_stage[1] = 0x2d0000,	/* 100m  */
				.hsync_stage[2] = 0x2b0956,	/* 200m  */
				.hsync_stage[3] = 0x290000,	/* 300m  */
				.hsync_stage[4] = 0x275000,	/* 400m  */
				.hsync_stage[5] = 0x123103,	/* 500m  */
			},
			#endif
			{
		...
		[ AHD20_720P_25P_EX_Btype ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x8af000,	/* short */
				.hsync_stage[1] = 0x8a5000,	/* 100m  */
				.hsync_stage[2] = 0x88b447,	/* 200m  */
				.hsync_stage[3] = 0x85d75a,	/* 300m  */
				.hsync_stage[4] = 0x805000,	/* 400m  */
				.hsync_stage[5] = 0x3fe13b,	/* 500m  */
			},
			#endif
			{
		...
		[ CVI_HD_30P_EX ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x8a9000,	/* short */
				.hsync_stage[1] = 0x89efdf,	/* 100m  */
				.hsync_stage[2] = 0x888000,	/* 200m  */
				.hsync_stage[3] = 0x83c382,	/* 300m  */
				.hsync_stage[4] = 0x7e5000,	/* 400m  */
				.hsync_stage[5] = 0x3cbc38,	/* 500m  */
			},
			#endif
			{
		...
		[ CVI_HD_25P_EX ] = { /* o */
			...
			#else
			{
				.hsync_stage[0] = 0x89a000,	/* short */
				.hsync_stage[1] = 0x86a000,	/* 100m  */
				.hsync_stage[2] = 0x8500c9,	/* 200m  */
				.hsync_stage[3] = 0x83fc26,	/* 300m  */
				.hsync_stage[4] = 0x7f6b15,	/* 400m  */
				.hsync_stage[5] = 0x3d3ae7,	/* 500m  */
			},
		...
		[ AHD30_5M_12_5P ] = { /* x */
			...
			#else
			{
				.hsync_stage[0] = 0x8aa000,	/* short */
				.hsync_stage[1] = 0x88f000,	/* 100m  */
				.hsync_stage[2] = 0x860000,	/* 200m  */
				.hsync_stage[3] = 0x830000,	/* 300m  */
				.hsync_stage[4] = 0x815000,	/* 400m  */
				.hsync_stage[5] = 0x3d69db,	/* 500m  */
			},
			#endif
			{
		...
		[ AHD30_3M_25P ] = { /* x */
			...
			#else
			{
				.hsync_stage[0] = 0x89d000,	/* short */
				.hsync_stage[1] = 0x88e000,	/* 100m  */
				.hsync_stage[2] = 0x86715b,	/* 200m  */
				.hsync_stage[3] = 0x8378a6,	/* 300m  */
				.hsync_stage[4] = 0x7e0000,	/* 400m  */
				.hsync_stage[5] = 0x406cea,	/* 500m  */
			},
			#endif
			{
		...
		[ AHD30_3M_30P ] = { /* x */
			...
			#else
			{
				.hsync_stage[0] = 0x8a8000,	/* short */
				.hsync_stage[1] = 0x880000,	/* 100m  */
				.hsync_stage[2] = 0x866ba3,	/* 200m  */
				.hsync_stage[3] = 0x84f215,	/* 300m  */
				.hsync_stage[4] = 0x7d0000,	/* 400m  */
				.hsync_stage[5] = 0x40bedd,	/* 500m  */
			},
			#endif
			{
...
//			.v_offset[0] 		= 0xfa, .v_offset[1] 		= 0xfc, .v_offset[2] 		= 0xfc, .v_offset[3] 		= 0xfc, .v_offset[4] 		= 0xfc, .v_offset[5] 		= 0xfc,
			.u_gain[0] 			= 0x58, .u_gain[1] 			= 0x58, .u_gain[2] 			= 0x58, .u_gain[3] 			= 0x58, .u_gain[4] 			= 0x58, .u_gain[5] 			= 0x58,
			.v_gain[0] 			= 0xd0, .v_gain[1] 			= 0xd0, .v_gain[2] 			= 0xd0, .v_gain[3] 			= 0xd0, .v_gain[4] 			= 0xd0, .v_gain[5] 			= 0xd0,
			.u_offset[0] 		= 0xf8, .u_offset[1] 		= 0xf8, .u_offset[2] 		= 0xf8, .u_offset[3] 		= 0xf8, .u_offset[4] 		= 0xf8, .u_offset[5] 		= 0xf8,
...
//			.black_level[0] 	= 0x81, .black_level[1] 	= 0x82, .black_level[2] 	= 0x83, .black_level[3] 	= 0x88, .black_level[4] 	= 0x90, .black_level[5] 	= 0x92,
			.black_level[0] 	= 0x86, .black_level[1] 	= 0x86, .black_level[2] 	= 0x86, .black_level[3] 	= 0x88, .black_level[4] 	= 0x90, .black_level[5] 	= 0x92,
...
//			.sub_saturation[0] 	= 0x90, .sub_saturation[1] 	= 0x90, .sub_saturation[2] 	= 0x90, .sub_saturation[3] 	= 0x40, .sub_saturation[4] 	= 0x40, .sub_saturation[5] 	= 0x40,
			.sub_saturation[0] 	= 0xe0, .sub_saturation[1] 	= 0xe0, .sub_saturation[2] 	= 0xe0, .sub_saturation[3] 	= 0xe0, .sub_saturation[4] 	= 0xe0, .sub_saturation[5] 	= 0xe0,
			...
			.burst_dec_c[0] 	= 0x20, .burst_dec_c[1] 	= 0x20, .burst_dec_c[2] 	= 0x20, .burst_dec_c[3] 	= 0x20, .burst_dec_c[4] 	= 0x20, .burst_dec_c[5] 	= 0x20,
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x7c, .h_delay_a[1] = 0x7c, .h_delay_a[2] = 0x7a, .h_delay_a[3] = 0x7a, .h_delay_a[4] = 0x7a, .h_delay_a[5] = 0x7a,
...
//			.sub_saturation[0]	= 0xb0, .sub_saturation[1]	= 0x90, .sub_saturation[2]	= 0x90, .sub_saturation[3]	= 0x80, .sub_saturation[4]	= 0x48, .sub_saturation[5]	= 0x20,
			.sub_saturation[0]	= 0xdf, .sub_saturation[1]	= 0xdf, .sub_saturation[2]	= 0xdf, .sub_saturation[3]	= 0xdf, .sub_saturation[4]	= 0xdf, .sub_saturation[5]	= 0xdf,
...
/*B9 0x9e*/ .h_scaler9[0]	= 0x14, .h_scaler9[1]	= 0x14, .h_scaler9[2]	= 0x14, .h_scaler9[3]	= 0x14, .h_scaler9[4]	= 0x14, .h_scaler9[5]	= 0x14,
	...
	[ CVI_FHD_25P ] = { /* o */
		...
		/* color */
		{
			.contrast[0] 		= 0x78, .contrast[1] 		= 0x78, .contrast[2] 		= 0x98, .contrast[3] 		= 0x98, .contrast[4] 		= 0x98, .contrast[5] 		= 0x98,
			...
			.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0xfe, .hue[3] 			= 0xfe, .hue[4] 			= 0xfe, .hue[5] 			= 0xfe,
			.u_gain[0] 		= 0x3f, .u_gain[1] 		= 0x3f, .u_gain[2] 		= 0x0c, .u_gain[3] 		= 0x0c, .u_gain[4] 		= 0x0c, .u_gain[5] 		= 0x0c,
			.v_gain[0] 		= 0xe0, .v_gain[1] 		= 0xe0, .v_gain[2] 		= 0x1a, .v_gain[3] 		= 0x1a, .v_gain[4] 		= 0x1a, .v_gain[5] 		= 0x1a,
			.u_offset[0] 		= 0x00, .u_offset[1] 		= 0x00, .u_offset[2] 		= 0xfa, .u_offset[3] 		= 0xfa, .u_offset[4] 		= 0xfa, .u_offset[5] 		= 0xfa,
			.v_offset[0] 		= 0x00, .v_offset[1] 		= 0x00, .v_offset[2] 		= 0xfa, .v_offset[3] 		= 0xfa, .v_offset[4] 		= 0xfa, .v_offset[5] 		= 0xfa,
		...
		{
			.h_delay_a[0] = 0x80, .h_delay_a[1] = 0x80, .h_delay_a[2] = 0x80, .h_delay_a[3] = 0x80, .h_delay_a[4] = 0x80, .h_delay_a[5] = 0x80,
			//.h_delay_a[0] = 0x5a, .h_delay_a[1] = 0x5a, .h_delay_a[2] = 0x5a, .h_delay_a[3] = 0x5a, .h_delay_a[4] = 0x5a, .h_delay_a[5] = 0x5a,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x00, .h_delay_c[1] = 0x00, .h_delay_c[2] = 0x00, .h_delay_c[3] = 0x00, .h_delay_c[4] = 0x00, .h_delay_c[5] = 0x00,
...
/*B9 0x9e*/	.h_scaler9[0]   = 0x80, .h_scaler9[1]   = 0x80, .h_scaler9[2]   = 0x80, .h_scaler9[3]   = 0x80, .h_scaler9[4]   = 0x80, .h_scaler9[5]   = 0x80,
	...
	[ TVI_4M_25P ] = /* o */
	{
		...
		/* color */
		{
			.contrast[0] 		= 0x90, .contrast[1] 		= 0x90, .contrast[2] 		= 0x98, .contrast[3] 		= 0x66, .contrast[4] 		= 0x61, .contrast[5] 		= 0x65,
			.h_peaking[0] 		= 0x10, .h_peaking[1] 	= 0x10, .h_peaking[2] 	= 0x10, .h_peaking[3] 	= 0x00, .h_peaking[4] 	= 0x30, .h_peaking[5] 	= 0x20,
			.c_filter[0]		= 0x92, .c_filter[1] 		= 0xB2, .c_filter[2]	 	= 0xb2, .c_filter[3] 		= 0xb2, .c_filter[4] 		= 0xb2, .c_filter[5] 		= 0xb2,

			.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x02, .hue[3] 			= 0x02, .hue[4] 			= 0x02, .hue[5] 			= 0x02,
//			.u_gain[0] 		= 0x7f, .u_gain[1] 		= 0x7f, .u_gain[2] 		= 0x34, .u_gain[3] 		= 0x34, .u_gain[4] 		= 0x34, .u_gain[5] 		= 0x34,
//			.v_gain[0] 		= 0xe0, .v_gain[1] 		= 0xe0, .v_gain[2] 		= 0x40, .v_gain[3] 		= 0x40, .v_gain[4] 		= 0x40, .v_gain[5] 		= 0x40,
//			.u_offset[0] 		= 0x08, .u_offset[1] 		= 0x08, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00,
//			.v_offset[0] 		= 0x00, .v_offset[1] 		= 0x00, .v_offset[2] 		= 0xf8, .v_offset[3] 		= 0xf8, .v_offset[4] 		= 0xf8, .v_offset[5] 		= 0xf8,

			.u_gain[0]		= 0x7f, .u_gain[1]		= 0x7f, .u_gain[2]		= 0x7f, .u_gain[3]		= 0x7f, .u_gain[4]		= 0x7f, .u_gain[5]		= 0x7f,
			.v_gain[0]		= 0xd8, .v_gain[1]		= 0xd8, .v_gain[2]		= 0xd8, .v_gain[3]		= 0xd8, .v_gain[4]		= 0xd8, .v_gain[5]		= 0xd8,
			.u_offset[0]		= 0xfc, .u_offset[1]		= 0xfc, .u_offset[2]		= 0xfc, .u_offset[3]		= 0xfc, .u_offset[4]		= 0xfc, .u_offset[5]		= 0xfc,
			.v_offset[0]		= 0xfc, .v_offset[1]		= 0xfc, .v_offset[2]		= 0xfc, .v_offset[3]		= 0xfc, .v_offset[4]		= 0xfc, .v_offset[5]		= 0xfc,
			...
			.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0xa0, .cti_delay[5]		= 0x80,
			//.sub_saturation[0] 	= 0xdf, .sub_saturation[1] 	= 0xdf, .sub_saturation[2] 	= 0x80, .sub_saturation[3] 	= 0x60, .sub_saturation[4] 	= 0x50, .sub_saturation[5] 	= 0x20,
			.sub_saturation[0] 	= 0xdf, .sub_saturation[1] 	= 0xdf, .sub_saturation[2] 	= 0xdf, .sub_saturation[3] 	= 0xdf, .sub_saturation[4] 	= 0xdf, .sub_saturation[5] 	= 0xdf,
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x78, .h_delay_a[1] = 0x78, .h_delay_a[2] = 0x76, .h_delay_a[3] = 0x76, .h_delay_a[4] = 0x76, .h_delay_a[5] = 0x76,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x02, .h_delay_c[1] = 0x02, .h_delay_c[2] = 0x02, .h_delay_c[3] = 0x02, .h_delay_c[4] = 0x02, .h_delay_c[5] = 0x02,
...
//			.sub_saturation[0] 	= 0x80, .sub_saturation[1] 	= 0x80, .sub_saturation[2] 	= 0x80, .sub_saturation[3] 	= 0x60, .sub_saturation[4] 	= 0x50, .sub_saturation[5] 	= 0x20,
	...
	[ TVI_5M_20P ] = { /* o */
			...
			/* color */
			{
					...
					.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x02, .hue[3] 			= 0x02, .hue[4] 			= 0x02, .hue[5] 			= 0x02,
//					.u_gain[0] 		= 0x7f, .u_gain[1] 		= 0x7f, .u_gain[2] 		= 0x34, .u_gain[3] 		= 0x34, .u_gain[4] 		= 0x34, .u_gain[5] 		= 0x34,
//					.v_gain[0] 		= 0x00, .v_gain[1] 		= 0x00, .v_gain[2] 		= 0x40, .v_gain[3] 		= 0x40, .v_gain[4] 		= 0x40, .v_gain[5] 		= 0x40,
//					.u_offset[0] 		= 0x00, .u_offset[1] 		= 0x00, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00,
//					.v_offset[0] 		= 0xf8, .v_offset[1] 		= 0xf8, .v_offset[2] 		= 0xf8, .v_offset[3] 		= 0xf8, .v_offset[4] 		= 0xf8, .v_offset[5] 		= 0xf8,
					...
					.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0xa0, .cti_delay[5]		= 0x80,
					//.sub_saturation[0] 	= 0xdf, .sub_saturation[1] 	= 0xdf, .sub_saturation[2] 	= 0x80, .sub_saturation[3] 	= 0x60, .sub_saturation[4] 	= 0x50, .sub_saturation[5] 	= 0x20,
					.sub_saturation[0] 	= 0xc8, .sub_saturation[1] 	= 0xc8, .sub_saturation[2] 	= 0xc8, .sub_saturation[3] 	= 0xc8, .sub_saturation[4] 	= 0xc8, .sub_saturation[5] 	= 0xc8,
			...
			/* timing_a */
			{
				.h_delay_a[0] = 0x7d, .h_delay_a[1] = 0x7d, .h_delay_a[2] = 0x7c, .h_delay_a[3] = 0x7a, .h_delay_a[4] = 0x7a, .h_delay_a[5] = 0x7a,
				.h_delay_b[0] = 0x00, .h_delay_b[1] = 0x00, .h_delay_b[2] = 0x00, .h_delay_b[3] = 0x00, .h_delay_b[4] = 0x00, .h_delay_b[5] = 0x00,
				.h_delay_c[0] = 0x00, .h_delay_c[1] = 0x00, .h_delay_c[2] = 0x00, .h_delay_c[3] = 0x00, .h_delay_c[4] = 0x00, .h_delay_c[5] = 0x00,
	...
	[ TVI_3M_18P ] = /* o */
		{
			...
			/* color */
			{
				...
				.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x02, .hue[3] 			= 0x02, .hue[4] 			= 0x02, .hue[5] 			= 0x02,
//				.u_gain[0] 		= 0x00, .u_gain[1] 		= 0x00, .u_gain[2] 		= 0x34, .u_gain[3] 		= 0x34, .u_gain[4] 		= 0x34, .u_gain[5] 		= 0x34,
//				.v_gain[0] 		= 0xe0, .v_gain[1] 		= 0xe0, .v_gain[2] 		= 0x40, .v_gain[3] 		= 0x40, .v_gain[4] 		= 0x40, .v_gain[5] 		= 0x40,
//				.u_offset[0] 		= 0x08, .u_offset[1] 		= 0x08, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00,
//				.v_offset[0] 		= 0xfc, .v_offset[1] 		= 0xfc, .v_offset[2] 		= 0xf8, .v_offset[3] 		= 0xf8, .v_offset[4] 		= 0xf8, .v_offset[5] 		= 0xf8,

				.u_gain[0] 			= 0x7f, .u_gain[1] 		= 0x7f, .u_gain[2] 		= 0x7f, .u_gain[3] 		= 0x7f, .u_gain[4] 		= 0x7f, .u_gain[5] 		= 0x7f,
				.v_gain[0] 			= 0xdf, .v_gain[1] 		= 0xdf, .v_gain[2] 		= 0xdf, .v_gain[3] 		= 0xdf, .v_gain[4] 		= 0xdf, .v_gain[5] 		= 0xdf,
				.u_offset[0] 		= 0x08, .u_offset[1] 		= 0x08, .u_offset[2] 		= 0x08, .u_offset[3] 		= 0x08, .u_offset[4] 		= 0x08, .u_offset[5] 		= 0x08,
				.v_offset[0] 		= 0xfa, .v_offset[1] 		= 0xfa, .v_offset[2] 		= 0xfa, .v_offset[3] 		= 0xfa, .v_offset[4] 		= 0xfa, .v_offset[5] 		= 0xfa,
...
//			.h_peaking[0] 	= 0x0f, .h_peaking[1] 		= 0x10, .h_peaking[2] 		= 0x20, .h_peaking[3] 		= 0x30, .h_peaking[4] 		= 0x40, .h_peaking[5] 		= 0x40,
			.h_peaking[0] 	= 0x30, .h_peaking[1] 		= 0x30, .h_peaking[2] 		= 0x30, .h_peaking[3] 		= 0x30, .h_peaking[4] 		= 0x30, .h_peaking[5] 		= 0x30,
			.c_filter[0]		= 0x82, .c_filter[1] 		= 0x82, .c_filter[2]	 	= 0x92, .c_filter[3] 		= 0x92, .c_filter[4] 		= 0xa2, .c_filter[5] 		= 0xb2,

			.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x00, .hue[3] 			= 0x00, .hue[4] 			= 0x00, .hue[5] 			= 0x00,
//			.u_gain[0] 			= 0x70, .u_gain[1] 			= 0x70, .u_gain[2] 			= 0x04, .u_gain[3] 			= 0xfc, .u_gain[4] 			= 0xfc, .u_gain[5] 			= 0xfc,
//			.v_gain[0] 			= 0xd8, .v_gain[1] 			= 0xd8, .v_gain[2] 			= 0x04, .v_gain[3] 			= 0xf4, .v_gain[4] 			= 0x08, .v_gain[5] 			= 0x08,
...
//			.black_level[0] 	= 0x80, .black_level[1] 	= 0x81, .black_level[2] 	= 0x81, .black_level[3] 	= 0x83, .black_level[4] 	= 0x85, .black_level[5] 	= 0x87,
			.black_level[0] 	= 0x88, .black_level[1] 	= 0x88, .black_level[2] 	= 0x88, .black_level[3] 	= 0x88, .black_level[4] 	= 0x88, .black_level[5] 	= 0x88,
...
//			.sub_saturation[0] 	= 0xa8, .sub_saturation[1] 	= 0xa8, .sub_saturation[2] 	= 0xa8, .sub_saturation[3] 	= 0xa8, .sub_saturation[4] 	= 0x90, .sub_saturation[5] 	= 0x90,
			.sub_saturation[0] 	= 0xd0, .sub_saturation[1] 	= 0xd0, .sub_saturation[2] 	= 0xd0, .sub_saturation[3] 	= 0xd0, .sub_saturation[4] 	= 0xd0, .sub_saturation[5] 	= 0xd0,
...
//			.sub_saturation[0] 	= 0xE0, .sub_saturation[1] 	= 0xE0, .sub_saturation[2] 	= 0xE0, .sub_saturation[3] 	= 0xd0, .sub_saturation[4] 	= 0xb4, .sub_saturation[5] 	= 0x90,
	...
	//		.burst_dec_c[0] 	= 0x50, .burst_dec_c[1] 	= 0x50, .burst_dec_c[2] 	= 0x50, .burst_dec_c[3] 	= 0x50, .burst_dec_c[4] 	= 0x50, .burst_dec_c[5] 	= 0x50,
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x7d, .h_delay_a[1] = 0x7d, .h_delay_a[2] = 0x7c, .h_delay_a[3] = 0x7c, .h_delay_a[4] = 0x7c, .h_delay_a[5] = 0x7c,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x02, .h_delay_c[1] = 0x02, .h_delay_c[2] = 0x02, .h_delay_c[3] = 0x02, .h_delay_c[4] = 0x02, .h_delay_c[5] = 0x02,
			.y_delay[0]   = 0x05, .y_delay[1]   = 0x05, .y_delay[2]   = 0x05, .y_delay[3]   = 0x05, .y_delay[4]   = 0x05, .y_delay[5] =   0x05,
...
//			.v_offset[0] 		= 0xf8, .v_offset[1] 		= 0xf8, .v_offset[2] 		= 0xf8, .v_offset[3] 		= 0xf8, .v_offset[4] 		= 0xf8, .v_offset[5] 		= 0xfb,
			.u_gain[0]			= 0x7f, .u_gain[1]			= 0x7f, .u_gain[2]			= 0x7f, .u_gain[3]			= 0x7f, .u_gain[4]			= 0x7f, .u_gain[5]			= 0x7f,
			.v_gain[0]			= 0x10, .v_gain[1]			= 0x10, .v_gain[2]			= 0x10, .v_gain[3]			= 0x10, .v_gain[4]			= 0x10, .v_gain[5]			= 0x10,
			.u_offset[0]		= 0xf8, .u_offset[1]		= 0xf8, .u_offset[2]		= 0xf8, .u_offset[3]		= 0xf8, .u_offset[4]		= 0xf8, .u_offset[5]		= 0xf8,
			.v_offset[0]		= 0xfa, .v_offset[1]		= 0xfa, .v_offset[2]		= 0xfa, .v_offset[3]		= 0xfa, .v_offset[4]		= 0xfa, .v_offset[5]		= 0xfa,

//			.black_level[0] 	= 0x80, .black_level[1] 	= 0x81, .black_level[2] 	= 0x81, .black_level[3] 	= 0x83, .black_level[4] 	= 0x85, .black_level[5] 	= 0x87,
			.black_level[0] 	= 0x84, .black_level[1] 	= 0x84, .black_level[2] 	= 0x84, .black_level[3] 	= 0x84, .black_level[4] 	= 0x84, .black_level[5] 	= 0x84,

			.acc_ref[0]			= 0x57, .acc_ref[1]			= 0x57, .acc_ref[2]			= 0x57, .acc_ref[3]			= 0x57, .acc_ref[4]			= 0x57, .acc_ref[5]			= 0x57,
			.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0x80, .cti_delay[5]		= 0x80,
//			.sub_saturation[0] 	= 0xa8, .sub_saturation[1] 	= 0xa8, .sub_saturation[2] 	= 0xa8, .sub_saturation[3] 	= 0xa8, .sub_saturation[4] 	= 0x90, .sub_saturation[5] 	= 0x90,
			.sub_saturation[0] 	= 0x98, .sub_saturation[1] 	= 0x98, .sub_saturation[2] 	= 0x98, .sub_saturation[3] 	= 0x98, .sub_saturation[4] 	= 0x98, .sub_saturation[5] 	= 0x98,
...
//			.sub_saturation[0] 	= 0xe8, .sub_saturation[1] 	= 0xe8, .sub_saturation[2] 	= 0xd8, .sub_saturation[3] 	= 0xf8, .sub_saturation[4] 	= 0xe8, .sub_saturation[5] 	= 0x90,
			.sub_saturation[0] 	= 0xe8, .sub_saturation[1] 	= 0xe8, .sub_saturation[2] 	= 0xe8, .sub_saturation[3] 	= 0xe8, .sub_saturation[4] 	= 0xe8, .sub_saturation[5] 	= 0xe8,
...
//			.burst_dec_c[0] 	= 0x40, .burst_dec_c[1] 	= 0x40, .burst_dec_c[2] 	= 0x40, .burst_dec_c[3] 	= 0x40, .burst_dec_c[4] 	= 0x40, .burst_dec_c[5] 	= 0x40,
	...
	/* base */
		...
		{
			//.h_delay_a[0] = 0x80, .h_delay_a[1] = 0x80, .h_delay_a[2] = 0x80, .h_delay_a[3] = 0x80, .h_delay_a[4] = 0x80, .h_delay_a[5] = 0x80,
			.h_delay_a[0] = 0x75, .h_delay_a[1] = 0x75, .h_delay_a[2] = 0x75, .h_delay_a[3] = 0x75, .h_delay_a[4] = 0x75, .h_delay_a[5] = 0x75,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x03, .h_delay_c[1] = 0x03, .h_delay_c[2] = 0x03, .h_delay_c[3] = 0x03, .h_delay_c[4] = 0x03, .h_delay_c[5] = 0x03,
			.y_delay[0]   = 0x05, .y_delay[1]   = 0x03, .y_delay[2]   = 0x03, .y_delay[3]   = 0x03, .y_delay[4]   = 0x03, .y_delay[5] =   0x03,
	...
	[ AHD30_3M_25P ] = /* o */
	{
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x75, .h_delay_a[1] = 0x75, .h_delay_a[2] = 0x72, .h_delay_a[3] = 0x70, .h_delay_a[4] = 0x70, .h_delay_a[5] = 0x70,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x03, .h_delay_c[1] = 0x03, .h_delay_c[2] = 0x03, .h_delay_c[3] = 0x03, .h_delay_c[4] = 0x03, .h_delay_c[5] = 0x03,
			.y_delay[0]   = 0x05, .y_delay[1]   = 0x05, .y_delay[2]   = 0x05, .y_delay[3]   = 0x05, .y_delay[4]   = 0x05, .y_delay[5] =   0x05,
...
/*B0 0x64*/ .v_delay[0]     = 0x21, .v_delay[1]     = 0x21, .v_delay[2]     = 0x21, .v_delay[3]     = 0x21, .v_delay[4]     = 0x21, .v_delay[5]     = 0x21,
	...
	/* base */
		...
		/* color */
		{
			.contrast[0] 		= 0x80, .contrast[1] 		= 0x80, .contrast[2] 		= 0x82, .contrast[3] 		= 0x80, .contrast[4] 		= 0x7c, .contrast[5] 		= 0x77,
			...
			.hue[0] 			= 0x02, .hue[1] 			= 0x02, .hue[2] 			= 0x00, .hue[3] 			= 0xfe, .hue[4] 			= 0xfe, .hue[5] 			= 0xfe,
//			.u_gain[0] 		= 0x7f, .u_gain[1] 		= 0x7f, .u_gain[2] 		= 0x04, .u_gain[3] 		= 0x7f, .u_gain[4] 		= 0x10, .u_gain[5] 		= 0x18,
//			.v_gain[0] 		= 0xf0, .v_gain[1] 		= 0xf0, .v_gain[2] 		= 0xf0, .v_gain[3] 		= 0xf0, .v_gain[4] 		= 0x0e, .v_gain[5] 		= 0x14,
//			.u_offset[0] 		= 0x00, .u_offset[1] 		= 0x00, .u_offset[2] 		= 0xfe, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0xfe, .u_offset[5] 		= 0xfe,
//			.v_offset[0] 		= 0x00, .v_offset[1] 		= 0x00, .v_offset[2] 		= 0xfb, .v_offset[3] 		= 0x00, .v_offset[4] 		= 0xfb, .v_offset[5] 		= 0xfb,
...
//			.black_level[0] 	= 0x90, .black_level[1] 	= 0x90, .black_level[2] 	= 0x81, .black_level[3] 	= 0x90, .black_level[4] 	= 0x83, .black_level[5] 	= 0x87,
			.black_level[0] 	= 0x8e, .black_level[1] 	= 0x8e, .black_level[2] 	= 0x8e, .black_level[3] 	= 0x8e, .black_level[4] 	= 0x8e, .black_level[5] 	= 0x8e,

			.acc_ref[0]		= 0x57, .acc_ref[1]		= 0x57, .acc_ref[2]		= 0x57, .acc_ref[3]		= 0x57, .acc_ref[4]		= 0x57, .acc_ref[5]		= 0x57,
			.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0x80, .cti_delay[5]		= 0x80,
//			.sub_saturation[0]	= 0xa8, .sub_saturation[1] 	= 0xa8, .sub_saturation[2] 	= 0xa8, .sub_saturation[3] 	= 0xa8, .sub_saturation[4] 	= 0x90, .sub_saturation[5] 	= 0x90,
			.sub_saturation[0]	= 0xa8, .sub_saturation[1] 	= 0xa8, .sub_saturation[2] 	= 0xa8, .sub_saturation[3] 	= 0xa8, .sub_saturation[4] 	= 0xa8, .sub_saturation[5] 	= 0xa8,
		...
		/* timing_a */// 1080p 370米长线会有绿边
		{
			.h_delay_a[0] = 0x78, .h_delay_a[1] = 0x76, .h_delay_a[2] = 0x73, .h_delay_a[3] = 0x73, .h_delay_a[4] = 0x8d, .h_delay_a[5] = 0x73,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x03, .h_delay_c[1] = 0x03, .h_delay_c[2] = 0x03, .h_delay_c[3] = 0x03, .h_delay_c[4] = 0x03, .h_delay_c[5] = 0x03,
			.y_delay[0]   = 0x05, .y_delay[1]   = 0x03, .y_delay[2]   = 0x03, .y_delay[3]   = 0x03, .y_delay[4]   = 0x03, .y_delay[5] =   0x03,
...
//		.sub_saturation[0] 	= 0xa8, .sub_saturation[1] 	= 0xa8, .sub_saturation[2] 	= 0xa8, .sub_saturation[3] 	= 0xa8, .sub_saturation[4] 	= 0x90, .sub_saturation[5] 	= 0x90,
	...
	/* timing_a */
	{
		.h_delay_a[0] = 0x7e, .h_delay_a[1] = 0x7b, .h_delay_a[2] = 0x73, .h_delay_a[3] = 0x73, .h_delay_a[4] = 0x8d, .h_delay_a[5] = 0x73,
		.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
		.h_delay_c[0] = 0x03, .h_delay_c[1] = 0x03, .h_delay_c[2] = 0x03, .h_delay_c[3] = 0x03, .h_delay_c[4] = 0x03, .h_delay_c[5] = 0x03,
		.y_delay[0]   = 0x05, .y_delay[1]   = 0x03, .y_delay[2]   = 0x03, .y_delay[3]   = 0x03, .y_delay[4]   = 0x03, .y_delay[5] =   0x03,
	...
	[ AHD30_8M_7_5P ] = { /* o */
		...
		[ AHD30_8M_12_5P ] = /* o */
		{
			...
			.eq_bypass[0] 	= 0x22, .eq_bypass[1] 	= 0x22, .eq_bypass[2] 	= 0x22, .eq_bypass[3] 	= 0x22, .eq_bypass[4] 	= 0x22, .eq_bypass[5] 	= 0x22,    // Bank5 0x30
			.eq_band_sel[0] = 0x77, .eq_band_sel[1] = 0x77, .eq_band_sel[2] = 0x77, .eq_band_sel[3] = 0x67, .eq_band_sel[4] = 0x57, .eq_band_sel[5] = 0x57,    // BankA 0x31
			.eq_gain_sel[0] = 0x78, .eq_gain_sel[1] = 0x79, .eq_gain_sel[2] = 0x7f, .eq_gain_sel[3] = 0x7e, .eq_gain_sel[4] = 0x7f, .eq_gain_sel[5] = 0x7f,    // BankA 0x32
			.deq_a_on[0] 	= 0x00, .deq_a_on[1] 	= 0x00, .deq_a_on[2] 	= 0x01, .deq_a_on[3] 	= 0x01, .deq_a_on[4] 	= 0x01, .deq_a_on[5] 	= 0x01,    // BankA 0x33
			.deq_a_sel[0] 	= 0x00, .deq_a_sel[1] 	= 0x91, .deq_a_sel[2] 	= 0x93, .deq_a_sel[3] 	= 0x98, .deq_a_sel[4] 	= 0x98, .deq_a_sel[5] 	= 0x98,    // BankA 0x34
			.deq_b_sel[0] 	= 0x00, .deq_b_sel[1] 	= 0x00, .deq_b_sel[2] 	= 0x00, .deq_b_sel[3] 	= 0x20, .deq_b_sel[4] 	= 0x00, .deq_b_sel[5] 	= 0x00,    // BankA 0x35
		},
		/* coeff */
		...
		{
			.contrast[0] 		= 0xa0, .contrast[1] 		= 0x9c, .contrast[2] 		= 0x90, .contrast[3] 		= 0x95, .contrast[4] 		= 0x90, .contrast[5] 		= 0x8a,
			.h_peaking[0] 	= 0x50, .h_peaking[1] 		= 0x50, .h_peaking[2] 		= 0x50, .h_peaking[3] 		= 0x50, .h_peaking[4] 		= 0x50, .h_peaking[5] 		= 0x50,
			.c_filter[0]		= 0x82, .c_filter[1] 		= 0x82, .c_filter[2]	 	= 0x92, .c_filter[3] 		= 0x92, .c_filter[4] 		= 0xa2, .c_filter[5] 		= 0xb2,
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x82, .h_delay_a[1] = 0x80, .h_delay_a[2] = 0x80, .h_delay_a[3] = 0x7f, .h_delay_a[4] = 0x7f, .h_delay_a[5] = 0x7f,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x01, .h_delay_c[1] = 0x01, .h_delay_c[2] = 0x01, .h_delay_c[3] = 0x01, .h_delay_c[4] = 0x01, .h_delay_c[5] = 0x01,
			.y_delay[0]   = 0x00, .y_delay[1]   = 0x00, .y_delay[2]   = 0x00, .y_delay[3]   = 0x00, .y_delay[4]   = 0x00, .y_delay[5] =   0x00,
	...
	/* base */
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x8b, .h_delay_a[1] = 0x8a, .h_delay_a[2] = 0x80, .h_delay_a[3] = 0x7f, .h_delay_a[4] = 0x7f, .h_delay_a[5] = 0x7f,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10,
			.h_delay_c[0] = 0x01, .h_delay_c[1] = 0x01, .h_delay_c[2] = 0x01, .h_delay_c[3] = 0x01, .h_delay_c[4] = 0x01, .h_delay_c[5] = 0x01,
			.y_delay[0]   = 0x05, .y_delay[1]   = 0x05, .y_delay[2]   = 0x05, .y_delay[3]   = 0x05, .y_delay[4]   = 0x05, .y_delay[5] =   0x05,
	...
	[ TVI_FHD_25P ] = /* o */
	{
		...
		/* color */
		{
			.contrast[0] 		= 0x90, .contrast[1] 		= 0x90, .contrast[2] 		= 0x78, .contrast[3] 		= 0x6c, .contrast[4] 		= 0x70, .contrast[5] 		= 0x68,
			.h_peaking[0] 		= 0x3f, .h_peaking[1] 	= 0x3f, .h_peaking[2] 	= 0x3f, .h_peaking[3] 	= 0x3f, .h_peaking[4] 	= 0x3f, .h_peaking[5] 	= 0x3f,
			.c_filter[0]		= 0x92, .c_filter[1] 		= 0x92, .c_filter[2]	 	= 0x92, .c_filter[3] 		= 0xb2, .c_filter[4] 		= 0xb2, .c_filter[5] 		= 0xb2,

			.hue[0] 			= 0xfb, .hue[1] 			= 0xfb, .hue[2] 			= 0xfe, .hue[3] 			= 0xfe, .hue[4] 			= 0xfe, .hue[5] 			= 0xfe,
//			.u_gain[0] 		= 0x7f, .u_gain[1] 		= 0x7f, .u_gain[2] 		= 0x00, .u_gain[3] 		= 0x00, .u_gain[4] 		= 0x00, .u_gain[5] 		= 0x00,
//			.v_gain[0] 		= 0xf0, .v_gain[1] 		= 0xf0, .v_gain[2] 		= 0xf8, .v_gain[3] 		= 0xf8, .v_gain[4] 		= 0xf8, .v_gain[5] 		= 0xf8,
//			.u_offset[0] 		= 0x08, .u_offset[1] 		= 0x08, .u_offset[2] 		= 0xff, .u_offset[3] 		= 0xff, .u_offset[4] 		= 0xff, .u_offset[5] 		= 0xff,
...
//			.black_level[0] 	= 0x86, .black_level[1] 	= 0x88, .black_level[2] 	= 0x88, .black_level[3] 	= 0x8c, .black_level[4] 	= 0x8f, .black_level[5] 	= 0x8f,
			.black_level[0] 	= 0x90, .black_level[1] 	= 0x90, .black_level[2] 	= 0x90, .black_level[3] 	= 0x90, .black_level[4] 	= 0x90, .black_level[5] 	= 0x90,
...
//			.u_gain[0] 			= 0x00, .u_gain[1] 			= 0x00, .u_gain[2] 			= 0x00, .u_gain[3] 			= 0x00, .u_gain[4] 			= 0x00, .u_gain[5] 			= 0x00, .u_gain[6] 			= 0x00, .u_gain[7] 			= 0x00, .u_gain[8] 			= 0x00, .u_gain[9] 			= 0x00, .u_gain[10] 		= 0x00,
			.u_gain[0] 			= 0x3f, .u_gain[1] 			= 0x3f, .u_gain[2] 			= 0x3f, .u_gain[3] 			= 0x3f, .u_gain[4] 			= 0x3f, .u_gain[5] 			= 0x3f, .u_gain[6] 			= 0x00, .u_gain[7] 			= 0x00, .u_gain[8] 			= 0x00, .u_gain[9] 			= 0x00, .u_gain[10] 		= 0x00,
...
//			.sub_saturation[0] 	= 0xa8, .sub_saturation[1] 	= 0xab, .sub_saturation[2] 	= 0xb0, .sub_saturation[3] 	= 0xb0, .sub_saturation[4] 	= 0xa4, .sub_saturation[5] 	= 0xa0, .sub_saturation[6] 	= 0xa0, .sub_saturation[7] 	= 0xa0, .sub_saturation[8] 	= 0xa0, .sub_saturation[9] 	= 0x90, .sub_saturation[10] = 0x90,
			.sub_saturation[0] 	= 0xff, .sub_saturation[1] 	= 0xff, .sub_saturation[2] 	= 0xff, .sub_saturation[3] 	= 0xff, .sub_saturation[4] 	= 0xff, .sub_saturation[5] 	= 0xff, .sub_saturation[6] 	= 0xa0, .sub_saturation[7] 	= 0xa0, .sub_saturation[8] 	= 0xa0, .sub_saturation[9] 	= 0x90, .sub_saturation[10] = 0x90,
			...
			.burst_dec_c[0] 	= 0x20, .burst_dec_c[1] 	= 0x20, .burst_dec_c[2] 	= 0x20, .burst_dec_c[3] 	= 0x20, .burst_dec_c[4] 	= 0x20, .burst_dec_c[5] 	= 0x20, .burst_dec_c[6] 	= 0x20, .burst_dec_c[7] 	= 0x20, .burst_dec_c[8] 	= 0x20, .burst_dec_c[9] 	= 0x20, .burst_dec_c[10] 	= 0x20,
...
/*B0 0x64*/ .v_delay[0]     = 0x20, .v_delay[1]     = 0x20, .v_delay[2]     = 0x20, .v_delay[3]     = 0x20, .v_delay[4]     = 0x20, .v_delay[5]     = 0x20, .v_delay[6]     = 0x20, .v_delay[7]     = 0x20, .v_delay[8]     = 0x20, .v_delay[9]     = 0x20, .v_delay[10]     = 0x20,
	...
	/*B0 0x64*/ .v_delay[0]     = 0x21, .v_delay[1]     = 0x21, .v_delay[2]     = 0x21, .v_delay[3]     = 0x21, .v_delay[4]     = 0x21, .v_delay[5]     = 0x21, .v_delay[6]     = 0x21, .v_delay[7]     = 0x21, .v_delay[8]     = 0x21, .v_delay[9]     = 0x21, .v_delay[10]     = 0x21,
		...
		[ AHD20_720P_30P ] = /* o */
		{
			...
			/* color */
			{
				.contrast[0] 		= 0x80, .contrast[1] 		= 0x80, .contrast[2] 		= 0x78, .contrast[3] 		= 0x88, .contrast[4] 		= 0x88, .contrast[5] 		= 0x7e, .contrast[6] 		= 0x78, .contrast[7] 		= 0x78, .contrast[8] 		= 0x74, .contrast[9] 		= 0x74, .contrast[10] 	= 0x74,
				.h_peaking[0] 		= 0x3f, .h_peaking[1] 	= 0x3f, .h_peaking[2] 	= 0x3f, .h_peaking[3] 	= 0x3f, .h_peaking[4] 	= 0x3f, .h_peaking[5] 	= 0x3f, .h_peaking[6] 	= 0x3f, .h_peaking[7] 	= 0x3f, .h_peaking[8] 	= 0x3f, .h_peaking[9] 	= 0x4f, .h_peaking[10] 	= 0x4f,
				.c_filter[0]		= 0x82, .c_filter[1] 		= 0x82, .c_filter[2]	 	= 0x82, .c_filter[3] 		= 0x82, .c_filter[4] 		= 0x92, .c_filter[5] 		= 0x92, .c_filter[6] 		= 0x92, .c_filter[7] 		= 0x92, .c_filter[8] 		= 0x92, .c_filter[9] 		= 0x92, .c_filter[10] 	= 0x92,

				.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x00, .hue[3] 			= 0x00, .hue[4] 			= 0x00, .hue[5] 			= 0x00, .hue[6] 			= 0x00, .hue[7] 			= 0x00, .hue[8] 			= 0x00, .hue[9] 			= 0x00, .hue[10] 			= 0x00,
				.u_gain[0] 		= 0x3f, .u_gain[1] 		= 0x3f, .u_gain[2] 		= 0x00, .u_gain[3] 		= 0x00, .u_gain[4] 		= 0x00, .u_gain[5] 		= 0x00, .u_gain[6] 		= 0x00, .u_gain[7] 		= 0x00, .u_gain[8] 		= 0x00, .u_gain[9] 		= 0x00, .u_gain[10] 		= 0x00,
				.v_gain[0] 		= 0xd0, .v_gain[1] 		= 0xd0, .v_gain[2] 		= 0x00, .v_gain[3] 		= 0x00, .v_gain[4] 		= 0x00, .v_gain[5] 		= 0x00, .v_gain[6] 		= 0x00, .v_gain[7] 		= 0x00, .v_gain[8] 		= 0x00, .v_gain[9] 		= 0x00, .v_gain[10] 		= 0x00,
				.u_offset[0] 		= 0xf8, .u_offset[1] 		= 0xf8, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00, .u_offset[6] 		= 0x00, .u_offset[7] 		= 0x00, .u_offset[8] 		= 0x00, .u_offset[9] 		= 0x00, .u_offset[10] 	= 0x00,
				.v_offset[0] 		= 0xf0, .v_offset[1] 		= 0xf0, .v_offset[2] 		= 0x00, .v_offset[3] 		= 0x00, .v_offset[4] 		= 0x00, .v_offset[5] 		= 0x00, .v_offset[6] 		= 0x00, .v_offset[7] 		= 0x00, .v_offset[8] 		= 0x00, .v_offset[9] 		= 0x00, .v_offset[10] 	= 0x00,
	...
	[ CVI_HD_25P ] = /* o */
	{
		...
		/* color */
		{
			.contrast[0] 		= 0x80, .contrast[1] 		= 0x80, .contrast[2] 		= 0x8a, .contrast[3] 		= 0x87, .contrast[4] 		= 0x85, .contrast[5] 		= 0x84, .contrast[6] 		= 0x80, .contrast[7] 		= 0x80, .contrast[8] 		= 0x79, .contrast[9] 		= 0x72, .contrast[10] 	= 0x72,
			...
			.hue[0] 			= 0xff, .hue[1] 			= 0xff, .hue[2] 			= 0x00, .hue[3] 			= 0x00, .hue[4] 			= 0x00, .hue[5] 			= 0x00, .hue[6] 			= 0x00, .hue[7] 			= 0x00, .hue[8] 			= 0x00, .hue[9] 			= 0x00, .hue[10] 			= 0x00,
			.u_gain[0] 		= 0x4f, .u_gain[1] 		= 0x4f, .u_gain[2] 		= 0x00, .u_gain[3] 		= 0x00, .u_gain[4] 		= 0x00, .u_gain[5] 		= 0x00, .u_gain[6] 		= 0x00, .u_gain[7] 		= 0x00, .u_gain[8] 		= 0x00, .u_gain[9] 		= 0x00, .u_gain[10] 		= 0x00,
			.v_gain[0] 		= 0xf0, .v_gain[1] 		= 0xf0, .v_gain[2] 		= 0x00, .v_gain[3] 		= 0x00, .v_gain[4] 		= 0x00, .v_gain[5] 		= 0x00, .v_gain[6] 		= 0x00, .v_gain[7] 		= 0x00, .v_gain[8] 		= 0x00, .v_gain[9] 		= 0x00, .v_gain[10] 		= 0x00,
			.u_offset[0] 		= 0xfc, .u_offset[1] 		= 0xfc, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00, .u_offset[6] 		= 0x00, .u_offset[7] 		= 0x00, .u_offset[8] 		= 0x00, .u_offset[9] 		= 0x00, .u_offset[10] 	= 0x00,
			.v_offset[0] 		= 0xf0, .v_offset[1] 		= 0xf0, .v_offset[2] 		= 0x00, .v_offset[3] 		= 0x00, .v_offset[4] 		= 0x00, .v_offset[5] 		= 0x00, .v_offset[6] 		= 0x00, .v_offset[7] 		= 0x00, .v_offset[8] 		= 0x00, .v_offset[9] 		= 0x00, .v_offset[10] 	= 0x00,
...
/*B0 0x85*/	.format_set2[0] = 0x02, .format_set2[1] = 0x02, .format_set2[2] = 0x02, .format_set2[3] = 0x02, .format_set2[4] = 0x02, .format_set2[5] = 0x02, .format_set2[6] = 0x02, .format_set2[7] = 0x02, .format_set2[8] = 0x02, .format_set2[9] = 0x02, .format_set2[10] = 0x02,
	...
	[ CVI_HD_25P_EX ] = /* o */
	{
		...
		/* color */
		{
			...
			.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x00, .hue[3] 			= 0x00, .hue[4] 			= 0x00, .hue[5] 			= 0x00, .hue[6] 			= 0x00, .hue[7] 			= 0x00, .hue[8] 			= 0x00, .hue[9] 			= 0x00, .hue[10] 			= 0x00,
//			.u_gain[0] 			= 0x00, .u_gain[1] 			= 0x00, .u_gain[2] 			= 0x00, .u_gain[3] 			= 0x00, .u_gain[4] 			= 0x00, .u_gain[5] 			= 0x00, .u_gain[6] 			= 0x00, .u_gain[7] 			= 0x00, .u_gain[8] 			= 0x00, .u_gain[9] 			= 0x00, .u_gain[10] 		= 0x00,
			.u_gain[0] 			= 0x70, .u_gain[1] 			= 0x70, .u_gain[2] 			= 0x70, .u_gain[3] 			= 0x70, .u_gain[4] 			= 0x70, .u_gain[5] 			= 0x70, .u_gain[6] 			= 0x00, .u_gain[7] 			= 0x00, .u_gain[8] 			= 0x00, .u_gain[9] 			= 0x00, .u_gain[10] 		= 0x00,
			.v_gain[0] 			= 0x00, .v_gain[1] 			= 0x00, .v_gain[2] 			= 0x00, .v_gain[3] 			= 0x00, .v_gain[4] 			= 0x00, .v_gain[5] 			= 0x00, .v_gain[6] 			= 0x00, .v_gain[7] 			= 0x00, .v_gain[8] 			= 0x00, .v_gain[9] 			= 0x00, .v_gain[10] 		= 0x00,
			.u_offset[0] 		= 0x00, .u_offset[1] 		= 0x00, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00, .u_offset[6] 		= 0x00, .u_offset[7] 		= 0x00, .u_offset[8] 		= 0x00, .u_offset[9] 		= 0x00, .u_offset[10] 		= 0x00,
			.v_offset[0] 		= 0x00, .v_offset[1] 		= 0x00, .v_offset[2] 		= 0x00, .v_offset[3] 		= 0x00, .v_offset[4] 		= 0x00, .v_offset[5] 		= 0x00, .v_offset[6] 		= 0x00, .v_offset[7] 		= 0x00, .v_offset[8] 		= 0x00, .v_offset[9] 		= 0x00, .v_offset[10] 		= 0x00,
...
/*B9 0x9e*/	.h_scaler9[0]   = 0x80, .h_scaler9[1]   = 0x80, .h_scaler9[2]   = 0x80, .h_scaler9[3]   = 0x80, .h_scaler9[4]   = 0x80, .h_scaler9[5]   = 0x80,
	...
	[ TVI_HD_25P ] = /* o */
	{
		...
		/* color */
		{
			.contrast[0] 		= 0x80, .contrast[1] 		= 0x80, .contrast[2] 		= 0x84, .contrast[3] 		= 0x81, .contrast[4] 		= 0x7f, .contrast[5] 		= 0x7e, .contrast[6] 		= 0x7a, .contrast[7] 		= 0x7a, .contrast[8] 		= 0x72, .contrast[9] 		= 0x6d, .contrast[10] 		= 0x6d,
			.h_peaking[0] 		= 0x00, .h_peaking[1] 	= 0x00, .h_peaking[2] 	= 0x00, .h_peaking[3] 	= 0x00, .h_peaking[4] 		= 0x00, .h_peaking[5] 		= 0x00, .h_peaking[6] 		= 0x00, .h_peaking[7] 		= 0x3f, .h_peaking[8] 		= 0x3f, .h_peaking[9] 		= 0x3f, .h_peaking[10] 		= 0x3f,
			...
			.hue[0] 			= 0x00, .hue[1] 			= 0x00, .hue[2] 			= 0x00, .hue[3] 			= 0x00, .hue[4] 			= 0x00, .hue[5] 			= 0x00, .hue[6] 			= 0x00, .hue[7] 			= 0x00, .hue[8] 			= 0x00, .hue[9] 			= 0x00, .hue[10] 			= 0x00,
//			.u_gain[0] 		= 0x7f, .u_gain[1] 		= 0x7f, .u_gain[2] 		= 0xe0, .u_gain[3] 		= 0xe0, .u_gain[4] 			= 0xe0, .u_gain[5] 			= 0xe0, .u_gain[6] 			= 0xe0, .u_gain[7] 			= 0xe0, .u_gain[8] 			= 0xe0, .u_gain[9] 			= 0x00, .u_gain[10] 		= 0x00,
//			.v_gain[0] 		= 0x00, .v_gain[1] 		= 0x00, .v_gain[2] 		= 0x00, .v_gain[3] 		= 0x00, .v_gain[4] 			= 0x00, .v_gain[5] 			= 0x00, .v_gain[6] 			= 0x00, .v_gain[7] 			= 0x00, .v_gain[8] 			= 0x00, .v_gain[9] 			= 0x00, .v_gain[10] 		= 0x00,
//			.u_offset[0] 		= 0xf8, .u_offset[1] 		= 0xf8, .u_offset[2] 		= 0xff, .u_offset[3] 		= 0xff, .u_offset[4] 		= 0xff, .u_offset[5] 		= 0xff, .u_offset[6] 		= 0xff, .u_offset[7] 		= 0xff, .u_offset[8] 		= 0xff, .u_offset[9] 		= 0x00, .u_offset[10] 		= 0x00,
//			.v_offset[0] 		= 0xf0, .v_offset[1] 		= 0xf0, .v_offset[2] 		= 0x00, .v_offset[3] 		= 0x00, .v_offset[4] 		= 0x00, .v_offset[5] 		= 0x00, .v_offset[6] 		= 0x00, .v_offset[7] 		= 0x00, .v_offset[8] 		= 0x00, .v_offset[9] 		= 0x00, .v_offset[10] 		= 0x00,
			.u_gain[0]			= 0x70, .u_gain[1]			= 0x70, .u_gain[2]			= 0x70, .u_gain[3]			= 0x70, .u_gain[4]			= 0x70, .u_gain[5]			= 0x70, .u_gain[6]			= 0x7e, .u_gain[7]			= 0x7e, .u_gain[8]			= 0x7e, .u_gain[9]			= 0x7e, .u_gain[10] 		= 0x7e,
			.v_gain[0]			= 0xdf, .v_gain[1]			= 0xdf, .v_gain[2]			= 0xdf, .v_gain[3]			= 0xdf, .v_gain[4]			= 0xdf, .v_gain[5]			= 0xdf, .v_gain[6]			= 0x00, .v_gain[7]			= 0x00, .v_gain[8]			= 0x00, .v_gain[9]			= 0x00, .v_gain[10] 		= 0x00,
			.u_offset[0]		= 0x08, .u_offset[1]		= 0x08, .u_offset[2]		= 0x08, .u_offset[3]		= 0x08, .u_offset[4]		= 0x08, .u_offset[5]		= 0x08, .u_offset[6]		= 0x00, .u_offset[7]		= 0x00, .u_offset[8]		= 0x00, .u_offset[9]		= 0x00, .u_offset[10]		= 0x00,
			.v_offset[0]		= 0xfa, .v_offset[1]		= 0xfa, .v_offset[2]		= 0xfa, .v_offset[3]		= 0xfa, .v_offset[4]		= 0xfa, .v_offset[5]		= 0xfa, .v_offset[6]		= 0x00, .v_offset[7]		= 0x00, .v_offset[8]		= 0x00, .v_offset[9]		= 0x00, .v_offset[10]		= 0x00,
			...
			.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0x80, .cti_delay[5]		= 0x80, .cti_delay[6]		= 0x80, .cti_delay[7]		= 0x80, .cti_delay[8]		= 0x80, .cti_delay[9]		= 0x80, .cti_delay[10]		= 0x80,
//			.sub_saturation[0] 	= 0xa8, .sub_saturation[1] 	= 0xaa, .sub_saturation[2] 	= 0xaa, .sub_saturation[3] 	= 0xac, .sub_saturation[4] 	= 0xa8, .sub_saturation[5] 	= 0xa6, .sub_saturation[6] 	= 0x98, .sub_saturation[7] 	= 0xa0, .sub_saturation[8] 	= 0xa0, .sub_saturation[9] 	= 0x50, .sub_saturation[10] = 0x50,
			.sub_saturation[0] 	= 0xef, .sub_saturation[1] 	= 0xef, .sub_saturation[2] 	= 0xef, .sub_saturation[3] 	= 0xef, .sub_saturation[4] 	= 0xef, .sub_saturation[5] 	= 0xef, .sub_saturation[6] 	= 0x98, .sub_saturation[7] 	= 0xa0, .sub_saturation[8] 	= 0xa0, .sub_saturation[9] 	= 0x50, .sub_saturation[10] = 0x50,
		...
		/* timing_a */
		{
			...
			.y_delay[0]   = 0x0f, .y_delay[1]   = 0x0f, .y_delay[2]   = 0x05, .y_delay[3]   = 0x05, .y_delay[4]   = 0x05, .y_delay[5] =   0x05, .y_delay[6] =   0x05, .y_delay[7] =   0x05, .y_delay[8] =   0x05, .y_delay[9] =   0x05, .y_delay[10] =   0x05,
...
//			.sub_saturation[0] 	= 0xa8, .sub_saturation[1] 	= 0xaa, .sub_saturation[2] 	= 0xaa, .sub_saturation[3] 	= 0xac, .sub_saturation[4] 	= 0xa8, .sub_saturation[5] 	= 0xa6, .sub_saturation[6] 	= 0x98, .sub_saturation[7] 	= 0xa0, .sub_saturation[8] 	= 0xa0, .sub_saturation[9] 	= 0x50, .sub_saturation[10] = 0x50,
	...
	/* base */
		...
		/* timing_a */
		{
			.h_delay_a[0] = 0x8f, .h_delay_a[1] = 0x8e, .h_delay_a[2] = 0x7f, .h_delay_a[3] = 0x7e, .h_delay_a[4] = 0x7e, .h_delay_a[5] = 0x7f, .h_delay_a[6] = 0x7f, .h_delay_a[7] = 0x7f, .h_delay_a[8] = 0x7f, .h_delay_a[9] = 0x7f, .h_delay_a[10] = 0x7f,
			.h_delay_b[0] = 0x10, .h_delay_b[1] = 0x10, .h_delay_b[2] = 0x10, .h_delay_b[3] = 0x10, .h_delay_b[4] = 0x10, .h_delay_b[5] = 0x10, .h_delay_b[6] = 0x10, .h_delay_b[7] = 0x10, .h_delay_b[8] = 0x10, .h_delay_b[9] = 0x10, .h_delay_b[10] = 0x10,
			.h_delay_c[0] = 0x01, .h_delay_c[1] = 0x01, .h_delay_c[2] = 0x01, .h_delay_c[3] = 0x01, .h_delay_c[4] = 0x01, .h_delay_c[5] = 0x01, .h_delay_c[6] = 0x01, .h_delay_c[7] = 0x01, .h_delay_c[8] = 0x01, .h_delay_c[9] = 0x01, .h_delay_c[10] = 0x01,
			.y_delay[0]   = 0x05, .y_delay[1]   = 0x05, .y_delay[2]   = 0x05, .y_delay[3]   = 0x05, .y_delay[4]   = 0x05, .y_delay[5] =   0x05, .y_delay[6] =   0x05, .y_delay[7] =   0x05, .y_delay[8] =   0x05, .y_delay[9] =   0x05, .y_delay[10] =   0x05,
...
//			.v_gain[0] 			= 0x00, .v_gain[1] 			= 0x00, .v_gain[2] 			= 0x00, .v_gain[3] 			= 0x00, .v_gain[4] 			= 0x00, .v_gain[5] 			= 0x00,
			.u_gain[0]			= 0x6f, .u_gain[1]			= 0x6f, .u_gain[2]			= 0x6f, .u_gain[3]			= 0x6f, .u_gain[4]			= 0x6f, .u_gain[5]			= 0x6f,
			.v_gain[0]			= 0xef, .v_gain[1]			= 0xef, .v_gain[2]			= 0xef, .v_gain[3]			= 0xef, .v_gain[4]			= 0xef, .v_gain[5]			= 0xef,				
			.u_offset[0] 		= 0x00, .u_offset[1] 		= 0x00, .u_offset[2] 		= 0x00, .u_offset[3] 		= 0x00, .u_offset[4] 		= 0x00, .u_offset[5] 		= 0x00,
			.v_offset[0] 		= 0x00, .v_offset[1] 		= 0x00, .v_offset[2] 		= 0x00, .v_offset[3] 		= 0x00, .v_offset[4] 		= 0x00, .v_offset[5] 		= 0x00,

			.black_level[0] 	= 0x85, .black_level[1] 	= 0x84, .black_level[2] 	= 0x84, .black_level[3] 	= 0x8c, .black_level[4] 	= 0x80, .black_level[5] 	= 0x80,
			.acc_ref[0]			= 0x57, .acc_ref[1]			= 0x57, .acc_ref[2]			= 0x57, .acc_ref[3]			= 0x57, .acc_ref[4]			= 0x47, .acc_ref[5]			= 0x47,
			.cti_delay[0]		= 0x80, .cti_delay[1]		= 0x80, .cti_delay[2]		= 0x80, .cti_delay[3]		= 0x80, .cti_delay[4]		= 0x80, .cti_delay[5]		= 0x80,
			//.sub_saturation[0] 	= 0xd0, .sub_saturation[1] 	= 0xf0, .sub_saturation[2] 	= 0xf0, .sub_saturation[3] 	= 0xe0, .sub_saturation[4] 	= 0xc0, .sub_saturation[5] 	= 0xc0,
			.sub_saturation[0] 	= 0xff, .sub_saturation[1] 	= 0xff, .sub_saturation[2] 	= 0xff, .sub_saturation[3] 	= 0xff, .sub_saturation[4] 	= 0xff, .sub_saturation[5] 	= 0xff,
